...
const Clients1 = ({ theme, subBG }) => {
  ...
  var third = Clients1Data.slice(8, 12);
  var fourth = Clients1Data.slice(12, Clients1Data.length)
                    ...
                    >
                      <div className="img">
                        {theme === "light" ? (
                          ...
                          <img src={item.darkImage} width="300px" height={300} alt="" />
                        )}
                        <Split>
                          <a
                            href="#0"
